...
Con este avance del proyecto se pudo empezar a obtener información acerca del dataset mas allá del análisis exploratorio. Gracias a la creación de reglas de asociación es posible identificar patrones en los datos que pueden explicar los resultados de cierto tipo de juegos, mientras que el análisis de la agrupación explica las características que tienen los juegos exitosos. Esta información es importante para los desarrolladores que busquen tener éxito en el mercado.
